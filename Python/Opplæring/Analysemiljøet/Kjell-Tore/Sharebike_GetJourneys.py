...
# 🔹 API-endepunktet
api_url = "https://api.sharebike.com/journey-service/dashboard/journeys?size=15&page=0&cityId=36"
...
# Lagre responsen som JSON-fil
    with open('sharebike_journeys.json', 'w') as json_file:
        json.dump(response.json(), json_file, indent=4)
    print("Data lagret i sharebike_journeys.json")
else:
