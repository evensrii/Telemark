...
#    "claims": "client_email":client_email, #Vet ikke helt hva dette er
...
# 🔹 API-endepunktet
#api_url = "https://api.sharebike.com/station-service/dashboard/vehicles?size=10&page=0&cityId=36"
api_url = "https://api.sharebike.com/station-service/dashboard/stations?size=10&page=0&cityId=36"
