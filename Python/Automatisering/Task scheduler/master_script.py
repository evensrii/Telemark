...
SCRIPTS = [
    ...
    (os.path.join(PYTHON_PATH, "Queries/03_Arbeid_og_naeringsliv/Sysselsetting/arbeidsmarkedstilknytning.py"), "Arbeid og naeringsliv - Arbeidsmarkedstilknytning per kommune"),
