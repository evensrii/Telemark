...
python "D:\Scripts\analyse\Telemark\Python\Queries\09_Innvadrere_og_inkludering\Arbeid_og_inntekt\andel_sysselsatte_innvandrere.py" > ./logs/log_sysselsatte.txt 2>&1
IF %ERRORLEVEL% NEQ 0 echo "Script1.py failed with error code %ERRORLEVEL%"

REM Run the second Python script
python "D:\Scripts\analyse\Telemark\Python\Queries\09_Innvadrere_og_inkludering\Innvandrerbefolkningen\botid.py" > ./logs/log_botid.txt 2>&1
