...
# Filter to only "transport" rows, exclude Telemark county row
df_filtered = df[(df["Variabel"] == "transport") & (df["Kommune"] != "Telemark")].copy()
...
file_name = "offentlig_transport.csv"
