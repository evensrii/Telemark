"""
Script to combine annual company/establishment grid datasets from GitHub.
...
GITHUB_FOLDER = "Data/Bystrategi_Grenland/Areal_og_byutvikling/Sentrumssoner/250x250/Bedrifter_250"
...
OUTPUT_FILENAME = "bedrifter_grenland_250.csv"
...
def combine_annual_datasets():
    """
    Main function to combine annual company/establishment grid datasets.
    ...
    for file_info in csv_files:
        ...
        # Identify the grid ID column (looking for SSBID250M or similar)
        grid_col = None
        ...
        # Convert company columns to integer
