## NB: Den unike datasett-IDen må jeg få tak i ved å monitorere "Network" ved manuell nedlasting, så da er jeg egentlig like langt...
...
def download_ssb_kart_data(attributes=None, format_type="Csv", language="nb", srid="32633"):
    ...
    dataset_id = "067d56b0-f529-7f1a-8000-432a2077faee" # <---- Må fanges opp "manuelt" i utviklermodus.
