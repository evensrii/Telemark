...
try:
    df_innvandrere = fetch_data(
        ...
        query_name="Innvandrere fullført VGO",
...
try:
    df_befolkningen = fetch_data(
        ...
        payload=payload_hele,  # The JSON payload for POST requests. If None, a GET request is used.
        error_messages=error_messages,
        query_name="Hele befolkningen fullført VGO",
        response_type="json",  # The expected response type, either 'json' or 'csv'.
        # delimiter=";", # The delimiter for CSV data (default: ';').
        # encoding="ISO-8859-1", # The encoding for CSV data (default: 'ISO-8859-1').
    )
...
github_folder = "Data/09_Innvandrere og inkludering/Utdanning"
