"""
FHI Query Script: Gjeld over tre ganger inntekt, husholdninger.txt
==================================================================

Auto-generated script for processing FHI query data.
Query file: Oppvekst og levekår/Levekår/Inntekt og gjeld/Gjeld over tre ganger inntekt, husholdninger.txt
...
query_file = os.path.join(
    ...
    "FHI", 
    "queries",
    "Oppvekst og levekår", "Levekår", "Inntekt og gjeld", "Gjeld over tre ganger inntekt, husholdninger.txt"
)

# Output configuration
output_filename = "gjeld_over_tre_ganger_inntekt_husholdninger.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Gjeld over tre ganger inntekt, husholdninger.txt")
print(f"{'=' * 70}\n")
...
# Rename value to Andel and divide by 100
