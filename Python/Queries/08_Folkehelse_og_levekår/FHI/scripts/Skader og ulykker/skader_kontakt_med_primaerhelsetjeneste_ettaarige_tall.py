"""
FHI Query Script: Skader, kontakt med primærhelsetjeneste, ettårige tall.txt
============================================================================

Auto-generated script for processing FHI query data.
Query file: Skader og ulykker/Skader, kontakt med primærhelsetjeneste, ettårige tall.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Skader og ulykker",
    "Skader, kontakt med primærhelsetjeneste, ettårige tall.txt"
)

# Output configuration
output_filename = "skader_kontakt_med_primaerhelsetjeneste_ettaarige_tall.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Skader, kontakt med primærhelsetjeneste, ettårige tall.txt")
print(f"{'=' * 70}\n")
...
output_dir = os.path.join(pythonpath, "Data", "08_Folkehelse og levekår", "Skader og ulykker")
