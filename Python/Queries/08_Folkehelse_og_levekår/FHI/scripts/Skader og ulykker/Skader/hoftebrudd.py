"""
FHI Query Script: Hoftebrudd.txt
================================

Auto-generated script for processing FHI query data.
Query file: Skader og ulykker/Skader/Hoftebrudd.txt
...
query_file = os.path.join(
    ...
    "FHI", 
    "queries",
    "Skader og ulykker", "Skader", "Hoftebrudd.txt"
)

# Output configuration
output_filename = "hoftebrudd.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Hoftebrudd.txt")
print(f"{'=' * 70}\n")
