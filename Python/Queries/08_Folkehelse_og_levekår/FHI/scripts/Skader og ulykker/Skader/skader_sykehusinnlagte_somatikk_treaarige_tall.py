"""
FHI Query Script: Skader, sykehusinnlagte, somatikk, treårige tall.txt
======================================================================

Auto-generated script for processing FHI query data.
Query file: Skader og ulykker/Skader/Skader, sykehusinnlagte, somatikk, treårige tall.txt
...
query_file = os.path.join(
    ...
    "FHI", 
    "queries",
    "Skader og ulykker", "Skader", "Skader, sykehusinnlagte, somatikk, treårige tall.txt"
)

# Output configuration
output_filename = "skader_sykehusinnlagte_somatikk_treaarige_tall.csv"
github_folder = "Data/08_Folkehelse og levekår/Skader og ulykker/Skader"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Skader, sykehusinnlagte, somatikk, treårige tall.txt")
print(f"{'=' * 70}\n")
