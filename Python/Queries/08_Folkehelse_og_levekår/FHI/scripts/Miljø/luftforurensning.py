"""
FHI Query Script: Luftforurensning.txt
======================================

Auto-generated script for processing FHI query data.
Query file: Miljø/Luftforurensning.txt
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Luftforurensning.txt")
print(f"{'=' * 70}\n")
...
# Rename Antall to Konsentrasjon_PM2_5
