"""
FHI Query Script: Grunnskolepoeng etter foreldrenes utdanningsnivå.txt
======================================================================

Auto-generated script for processing FHI query data.
Query file: Grunnskole/Grunnskolepoeng etter foreldrenes utdanningsnivå.txt
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Grunnskolepoeng etter foreldrenes utdanningsnivå.txt")
print(f"{'=' * 70}\n")
