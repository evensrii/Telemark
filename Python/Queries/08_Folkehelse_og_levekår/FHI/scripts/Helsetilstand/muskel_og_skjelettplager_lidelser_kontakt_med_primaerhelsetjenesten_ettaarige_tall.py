...
Query file: Helsetilstand/Muskel- og skjelettplager lidelser, kontakt med primærhelsetjenesten, ettårige tall.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Muskel- og skjelettplager lidelser, kontakt med primærhelsetjenesten, ettårige tall.txt"
)
