...
Query file: Helsetilstand/Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt"
)
