"""
FHI Query Script: Hjerte- og karsykdom - primærhelsetjenesten, ettårige tall.txt
================================================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Hjerte- og karsykdom - primærhelsetjenesten, ettårige tall.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Hjerte- og karsykdom - primærhelsetjenesten, ettårige tall.txt"
)

# Output configuration
output_filename = "hjerte_og_karsykdom_primaerhelsetjenesten_ettaarige_tall.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Hjerte- og karsykdom - primærhelsetjenesten, ettårige tall.txt")
print(f"{'=' * 70}\n")
