"""
FHI Query Script: Psykiske plager, ungdom.txt
=============================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Psykiske plager, ungdom.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Psykiske plager, ungdom.txt"
)

# Output configuration
output_filename = "psykiske_plager_ungdom.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Psykiske plager, ungdom.txt")
print(f"{'=' * 70}\n")
