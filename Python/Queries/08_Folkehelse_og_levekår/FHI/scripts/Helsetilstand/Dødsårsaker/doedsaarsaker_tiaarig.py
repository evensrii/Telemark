"""
FHI Query Script: Dødsårsaker tiårig.txt
========================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Dødsårsaker/Dødsårsaker tiårig.txt
...
query_file = os.path.join(
    ...
    "FHI", 
    "queries",
    "Helsetilstand", "Dødsårsaker", "Dødsårsaker tiårig.txt"
)

# Output configuration
output_filename = "doedsaarsaker_tiaarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Dødsårsaker tiårig.txt")
print(f"{'=' * 70}\n")
