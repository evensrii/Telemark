"""
FHI Query Script: Selvmord.txt
==============================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Dødsårsaker/Selvmord.txt
...
query_file = os.path.join(
    ...
    "FHI", 
    "queries",
    "Helsetilstand", "Dødsårsaker", "Selvmord.txt"
)

# Output configuration
output_filename = "selvmord.csv"
github_folder = "Data/08_Folkehelse og levekår/Helsetilstand/Dødsårsaker"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Selvmord.txt")
print(f"{'=' * 70}\n")
...
# Rename columns specific to this dataset
df = df.rename(columns={'Dødsår': 'År', 'Bofylke': 'Kommune'})

# Remove any non-numeric/non-dash symbols from År (e.g. asterisks)
if 'År' in df.columns:
