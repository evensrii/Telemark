"""
FHI Query Script: Reseptfrie smertestillende legemidler, ungdom.txt
===================================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Reseptfrie smertestillende legemidler, ungdom.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Reseptfrie smertestillende legemidler, ungdom.txt"
)

# Output configuration
output_filename = "reseptfrie_smertestillende_legemidler_ungdom.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Reseptfrie smertestillende legemidler, ungdom.txt")
print(f"{'=' * 70}\n")
