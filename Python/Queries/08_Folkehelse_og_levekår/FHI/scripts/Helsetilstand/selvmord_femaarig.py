"""
FHI Query Script: Selvmord, femårig.txt
=======================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Selvmord, femårig.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Selvmord, femårig.txt"
)

# Output configuration
output_filename = "selvmord_femaarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Selvmord, femårig.txt")
print(f"{'=' * 70}\n")
