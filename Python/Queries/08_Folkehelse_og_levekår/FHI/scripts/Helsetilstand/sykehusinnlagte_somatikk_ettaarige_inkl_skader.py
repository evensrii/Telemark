"""
FHI Query Script: Sykehusinnlagte, somatikk, ettårige. inkl. skader.txt
=======================================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Sykehusinnlagte, somatikk, ettårige. inkl. skader.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Sykehusinnlagte, somatikk, ettårige. inkl. skader.txt"
)

# Output configuration
output_filename = "sykehusinnlagte_somatikk_ettaarige_inkl_skader.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Sykehusinnlagte, somatikk, ettårige. inkl. skader.txt")
print(f"{'=' * 70}\n")
