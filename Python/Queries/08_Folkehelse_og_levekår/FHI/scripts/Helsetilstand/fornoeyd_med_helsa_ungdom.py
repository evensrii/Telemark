"""
FHI Query Script: Fornøyd med helsa - ungdom.txt
================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Fornøyd med helsa - ungdom.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Fornøyd med helsa - ungdom.txt"
)

# Output configuration
output_filename = "fornoeyd_med_helsa_ungdom.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Fornøyd med helsa - ungdom.txt")
print(f"{'=' * 70}\n")
