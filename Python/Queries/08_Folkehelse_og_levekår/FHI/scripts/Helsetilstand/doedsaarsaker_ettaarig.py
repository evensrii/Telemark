"""
FHI Query Script: Dødsårsaker, ettårig.txt
==========================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Dødsårsaker, ettårig.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Dødsårsaker, ettårig.txt"
)

# Output configuration
output_filename = "doedsaarsaker_ettaarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Dødsårsaker, ettårig.txt")
print(f"{'=' * 70}\n")
