"""
FHI Query Script: Barnevaksinasjonsprogrammet.txt
=================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Vaksinasjon/Barnevaksinasjonsprogrammet.txt
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Barnevaksinasjonsprogrammet.txt")
print(f"{'=' * 70}\n")
