"""
FHI Query Script: Forventet levealder etter utdanning, 7 årig.txt
=================================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Forventet levealder etter utdanning, 7 årig.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Forventet levealder etter utdanning, 7 årig.txt"
)

# Output configuration
output_filename = "forventet_levealder_etter_utdanning_7_aarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Forventet levealder etter utdanning, 7 årig.txt")
print(f"{'=' * 70}\n")
