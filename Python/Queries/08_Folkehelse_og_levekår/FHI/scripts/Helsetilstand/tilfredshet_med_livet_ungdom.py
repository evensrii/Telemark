"""
FHI Query Script: Tilfredshet med livet, ungdom.txt
===================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Tilfredshet med livet, ungdom.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Tilfredshet med livet, ungdom.txt"
)

# Output configuration
output_filename = "tilfredshet_med_livet_ungdom.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Tilfredshet med livet, ungdom.txt")
print(f"{'=' * 70}\n")
