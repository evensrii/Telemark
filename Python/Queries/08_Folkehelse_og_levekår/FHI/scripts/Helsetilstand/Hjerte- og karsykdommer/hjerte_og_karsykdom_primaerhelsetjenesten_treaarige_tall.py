"""
FHI Query Script: Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt
================================================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Hjerte- og karsykdommer/Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt")
print(f"{'=' * 70}\n")
