"""
FHI Query Script: Kols, dødsårsak, ettårig.txt
==============================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Kols, dødsårsak, ettårig.txt
...
query_file = os.path.join(
    ...
    "queries",
    "Helsetilstand",
    "Kols, dødsårsak, ettårig.txt"
)

# Output configuration
output_filename = "kols_doedsaarsak_ettaarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Kols, dødsårsak, ettårig.txt")
print(f"{'=' * 70}\n")
