"""
FHI Query Script: Forventet levealder 7 årig.txt
================================================

Auto-generated script for processing FHI query data.
Query file: Helsetilstand/Forventet levealder/Forventet levealder 7 årig.txt
...
# %%
print(f"\n{'=' * 70}")
print(f"FHI Query: Forventet levealder 7 årig.txt")
print(f"{'=' * 70}\n")
