"""
Fylkessammenligning Query Script: Luftforurensning.txt
==================================================

Auto-generated county-comparison variant of the FHI query
"Luftforurensning.txt" (see FHI/scripts/ for the production, per-kommune version).
...
query_file = os.path.join(
    ...
    "fylkessammenligning",
    "queries",
    "Miljø", "Luftforurensning.txt"
)

# Output configuration (local only - not pushed to GitHub)
output_filename = "luftforurensning.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Luftforurensning.txt")
print(f"{'=' * 70}\n")
