"""
Fylkessammenligning Query Script: Influensavaksinerte over 65 år.txt
================================================================

Auto-generated county-comparison variant of the FHI query
"Influensavaksinerte over 65 år.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Influensavaksinerte over 65 år.txt")
print(f"{'=' * 70}\n")
