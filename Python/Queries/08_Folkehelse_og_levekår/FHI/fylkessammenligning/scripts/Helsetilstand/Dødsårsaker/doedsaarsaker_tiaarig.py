"""
Fylkessammenligning Query Script: Dødsårsaker tiårig.txt
====================================================

Auto-generated county-comparison variant of the FHI query
"Dødsårsaker tiårig.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Dødsårsaker tiårig.txt")
print(f"{'=' * 70}\n")
