"""
Fylkessammenligning Query Script: Forventet levealder 7 årig.txt
============================================================

Auto-generated county-comparison variant of the FHI query
"Forventet levealder 7 årig.txt" (see FHI/scripts/ for the production, per-kommune version).
...
query_file = os.path.join(
    ...
    "fylkessammenligning",
    "queries",
    "Helsetilstand", "Forventet levealder", "Forventet levealder 7 årig.txt"
)

# Output configuration (local only - not pushed to GitHub)
output_filename = "forventet_levealder_7_aarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Forventet levealder 7 årig.txt")
print(f"{'=' * 70}\n")
