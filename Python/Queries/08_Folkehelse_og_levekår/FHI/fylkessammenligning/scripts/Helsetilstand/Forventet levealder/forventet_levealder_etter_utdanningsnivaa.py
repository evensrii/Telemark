"""
Fylkessammenligning Query Script: Forventet levealder etter utdanningsnivå.txt
==========================================================================

Auto-generated county-comparison variant of the FHI query
"Forventet levealder etter utdanningsnivå.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Forventet levealder etter utdanningsnivå.txt")
print(f"{'=' * 70}\n")
