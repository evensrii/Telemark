"""
Fylkessammenligning Query Script: Kreft dødsårsak ettårig.txt
=========================================================

Auto-generated county-comparison variant of the FHI query
"Kreft dødsårsak ettårig.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Kreft dødsårsak ettårig.txt")
print(f"{'=' * 70}\n")
