"""
Fylkessammenligning Query Script: Overvekt og fedme, 17 år, fireårig.txt
====================================================================

Auto-generated county-comparison variant of the FHI query
"Overvekt og fedme, 17 år, fireårig.txt" (see FHI/scripts/ for the production, per-kommune version).
...
query_file = os.path.join(
    ...
    "fylkessammenligning",
    "queries",
    "Helsetilstand", "Sykdomsgrupper", "Overvekt og fedme, 17 år, fireårig.txt"
)

# Output configuration (local only - not pushed to GitHub)
output_filename = "overvekt_og_fedme_17_aar_fireaarig.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Overvekt og fedme, 17 år, fireårig.txt")
print(f"{'=' * 70}\n")
