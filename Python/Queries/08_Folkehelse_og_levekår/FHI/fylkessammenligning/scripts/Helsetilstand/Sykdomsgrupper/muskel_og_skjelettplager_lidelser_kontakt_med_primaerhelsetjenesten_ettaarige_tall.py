"""
Fylkessammenligning Query Script: Muskel- og skjelettplager lidelser, kontakt med primærhelsetjenesten, ettårige tall.txt
=====================================================================================================================

Auto-generated county-comparison variant of the FHI query
"Muskel- og skjelettplager lidelser, kontakt med primærhelsetjenesten, ettårige tall.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Muskel- og skjelettplager lidelser, kontakt med primærhelsetjenesten, ettårige tall.txt")
print(f"{'=' * 70}\n")
