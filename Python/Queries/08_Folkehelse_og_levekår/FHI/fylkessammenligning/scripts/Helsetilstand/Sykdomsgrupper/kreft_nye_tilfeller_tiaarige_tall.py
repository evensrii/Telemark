"""
Fylkessammenligning Query Script: Kreft, nye tilfeller, tiårige tall.txt
====================================================================

Auto-generated county-comparison variant of the FHI query
"Kreft, nye tilfeller, tiårige tall.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Kreft, nye tilfeller, tiårige tall.txt")
print(f"{'=' * 70}\n")
