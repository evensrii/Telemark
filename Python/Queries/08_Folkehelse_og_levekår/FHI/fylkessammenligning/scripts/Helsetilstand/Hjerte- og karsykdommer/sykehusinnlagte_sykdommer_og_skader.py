"""
Fylkessammenligning Query Script: Sykehusinnlagte sykdommer og skader.txt
=====================================================================

Auto-generated county-comparison variant of the FHI query
"Sykehusinnlagte sykdommer og skader.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Sykehusinnlagte sykdommer og skader.txt")
print(f"{'=' * 70}\n")
