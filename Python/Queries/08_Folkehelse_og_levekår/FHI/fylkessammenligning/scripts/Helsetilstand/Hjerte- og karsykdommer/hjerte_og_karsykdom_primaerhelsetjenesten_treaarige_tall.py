"""
Fylkessammenligning Query Script: Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt
============================================================================================

Auto-generated county-comparison variant of the FHI query
"Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt" (see FHI/scripts/ for the production, per-kommune version).
...
query_file = os.path.join(
    ...
    "fylkessammenligning",
    "queries",
    "Helsetilstand", "Hjerte- og karsykdommer", "Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt"
)

# Output configuration (local only - not pushed to GitHub)
output_filename = "hjerte_og_karsykdom_primaerhelsetjenesten_treaarige_tall.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Hjerte- og karsykdom - primærhelsetjenesten, treårige tall.txt")
print(f"{'=' * 70}\n")
