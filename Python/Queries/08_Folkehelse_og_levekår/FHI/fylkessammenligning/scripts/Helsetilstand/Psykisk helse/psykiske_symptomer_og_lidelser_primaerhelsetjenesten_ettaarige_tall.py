"""
Fylkessammenligning Query Script: Psykiske symptomer og lidelser - primærhelsetjenesten, ettårige tall.txt
======================================================================================================

Auto-generated county-comparison variant of the FHI query
"Psykiske symptomer og lidelser - primærhelsetjenesten, ettårige tall.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Psykiske symptomer og lidelser - primærhelsetjenesten, ettårige tall.txt")
print(f"{'=' * 70}\n")
