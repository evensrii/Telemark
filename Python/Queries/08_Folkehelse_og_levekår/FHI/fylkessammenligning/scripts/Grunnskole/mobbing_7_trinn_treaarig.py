"""
Fylkessammenligning Query Script: Mobbing 7. trinn treårig.txt
==========================================================

Auto-generated county-comparison variant of the FHI query
"Mobbing 7. trinn treårig.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Mobbing 7. trinn treårig.txt")
print(f"{'=' * 70}\n")
