"""
Fylkessammenligning Query Script: Regneferdighet treårig 5. og 8. trinn.txt
=======================================================================

Auto-generated county-comparison variant of the FHI query
"Regneferdighet treårig 5. og 8. trinn.txt" (see FHI/scripts/ for the production, per-kommune version).
...
query_file = os.path.join(
    ...
    "fylkessammenligning",
    "queries",
    "Grunnskole", "Regneferdighet treårig 5. og 8. trinn.txt"
)

# Output configuration (local only - not pushed to GitHub)
output_filename = "regneferdighet_treaarig_5_og_8_trinn.csv"
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Regneferdighet treårig 5. og 8. trinn.txt")
print(f"{'=' * 70}\n")
