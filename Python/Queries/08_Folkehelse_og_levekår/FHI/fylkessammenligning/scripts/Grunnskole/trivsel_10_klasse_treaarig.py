"""
Fylkessammenligning Query Script: Trivsel 10. klasse treårig.txt
============================================================

Auto-generated county-comparison variant of the FHI query
"Trivsel 10. klasse treårig.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Trivsel 10. klasse treårig.txt")
print(f"{'=' * 70}\n")
