"""
Fylkessammenligning Query Script: Hoftebrudd.txt
============================================

Auto-generated county-comparison variant of the FHI query
"Hoftebrudd.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Hoftebrudd.txt")
print(f"{'=' * 70}\n")
