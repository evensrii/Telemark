"""
Fylkessammenligning Query Script: Skader, sykehusinnlagte, somatikk, treårige tall.txt
==================================================================================

Auto-generated county-comparison variant of the FHI query
"Skader, sykehusinnlagte, somatikk, treårige tall.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Skader, sykehusinnlagte, somatikk, treårige tall.txt")
print(f"{'=' * 70}\n")
