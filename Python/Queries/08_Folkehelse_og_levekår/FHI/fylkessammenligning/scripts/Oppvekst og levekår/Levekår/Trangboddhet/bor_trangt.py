"""
Fylkessammenligning Query Script: Bor trangt.txt
============================================

Auto-generated county-comparison variant of the FHI query
"Bor trangt.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Bor trangt.txt")
print(f"{'=' * 70}\n")
