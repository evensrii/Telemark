"""
Fylkessammenligning Query Script: Gjeld over tre ganger inntekt, husholdninger.txt
==============================================================================

Auto-generated county-comparison variant of the FHI query
"Gjeld over tre ganger inntekt, husholdninger.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Gjeld over tre ganger inntekt, husholdninger.txt")
print(f"{'=' * 70}\n")
