"""
Fylkessammenligning Query Script: Vedvarende lavinntekt etter innvandringskategori, kommunegrense.txt
=================================================================================================

Auto-generated county-comparison variant of the FHI query
"Vedvarende lavinntekt etter innvandringskategori, kommunegrense.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Vedvarende lavinntekt etter innvandringskategori, kommunegrense.txt")
print(f"{'=' * 70}\n")
