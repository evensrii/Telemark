"""
Fylkessammenligning Query Script: Inntektsulikhet.txt
=================================================

Auto-generated county-comparison variant of the FHI query
"Inntektsulikhet.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: Inntektsulikhet.txt")
print(f"{'=' * 70}\n")
