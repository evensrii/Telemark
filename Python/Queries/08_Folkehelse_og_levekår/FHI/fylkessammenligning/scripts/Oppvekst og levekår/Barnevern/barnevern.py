"""
Fylkessammenligning Query Script: barnevern.txt
===========================================

Auto-generated county-comparison variant of the FHI query
"barnevern.txt" (see FHI/scripts/ for the production, per-kommune version).
...
# %%
print(f"\n{'=' * 70}")
print(f"Fylkessammenligning Query: barnevern.txt")
print(f"{'=' * 70}\n")
