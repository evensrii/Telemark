    ...
    <style>
        * {{
        ...
        .sankey-back {{
            ...
            padding: 3px 8px;
            border-radius: 4px;
            border: 1px solid {COLOR_TELEMARK};
            font-weight: 600;
            white-space: nowrap;
            position: absolute;
            right: 4px;
...
<body>
    <div class="header">
        ...
        <img class="header-logo" src="https://github.com/evensrii/Telemark/blob/main/Egne%20applikasjoner/Flytting/T_logo_02_Sidestilt_RGB_hvit_tekst.png?raw=true" alt="Telemark fylkeskommune" />
    </div>
    ...
    levelLabels.forEach(lbl => {{
        lbl.addEventListener('click', () => {{
            ...
            if (currentLevel === 'kommune') {{
                ...
                subtitle.textContent = 'Kommuneniv\u00e5';
            }} else {{
    ...
    function buildTopTable(tilRows, fraRows, direction, showAll) {{
        ...
        if ((direction === 'both' || direction === 'tilflytting') && topTil.length > 0) {{
            ...
            headerRow.innerHTML = '<td colspan="3" style="background:#e8f0fe;font-weight:600;color:{COLOR_TILFLYTTING};padding:5px 8px;">\u25b6 Tilflytting (inn)</td>';
        ...
        if ((direction === 'both' || direction === 'fraflytting') && topFra.length > 0) {{
            const headerRow = document.createElement('tr');
            headerRow.innerHTML = '<td colspan="3" style="background:#fce8e4;font-weight:600;color:{COLOR_FRAFLYTTING};padding:5px 8px;">\u25b6 Fraflytting (ut)</td>';
            tbody.appendChild(headerRow);
            topFra.forEach(r => {{
                const tr = document.createElement('tr');
    ...
    function updateKommune(kommune, direction) {{
        ...
        document.getElementById('header-subtitle').textContent = 'Kommuneniv\u00e5';
    ...
    function updateStats(label, totalIn, totalOut) {{
        ...
        box.innerHTML = `
            ...
            Fraflytting: <span class="stat-value" style="color:{COLOR_FRAFLYTTING}">${{totalOut.toLocaleString('nb-NO')}}</span><br>
